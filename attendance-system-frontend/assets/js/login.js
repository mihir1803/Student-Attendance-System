...
function redirect() {
    if (localStorage.is_authenticated == "true" && user_role == "Student")
        window.location.href = "/student-home.html"
    else if (localStorage.is_authenticated == "true" && user_role == "Faculty")
        window.location.href = "/faculty-home.html"
    else if (localStorage.is_authenticated == "true" && user_role == "college-admin")
