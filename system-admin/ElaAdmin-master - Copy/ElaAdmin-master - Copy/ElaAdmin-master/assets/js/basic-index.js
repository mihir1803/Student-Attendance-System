          ...
          <div id="main-menu" class="main-menu collapse navbar-collapse">
              <ul class="nav navbar-nav">
                  ...
                  <li class="menu-item-has-children">
                      <a href="college-list.html" class="dropdown-toggle" aria-haspopup="true" aria-expanded="false"> <i
                              class="menu-icon fa fa-tasks"></i>Colleges</a>
                  </li>
                  ...
                  <li class="menu-item-has-children dropdown">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                          aria-expanded="false"> <i class="menu-icon fa fa-table"></i>Query</a>
                      <ul class="sub-menu children dropdown-menu">
                          <li><i class="fa fa-table"></i><a href="query.html">Query</a></li>
                          <li><i class="fa fa-table"></i><a href="answer-home.html">Answer</a></li>
                      </ul>
                  </li>
                  ...
                  <li class="menu-item-has-children">
                      <a href="#" class="dropdown-toggle" aria-haspopup="true" aria-expanded="false"> <i
                              class="menu-icon fa fa-tasks"></i>Face Data</a>
                  </li>
